...
export default function DeleteRegistrationModal({
 ...
 {/* Modal Card */}
 <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl shadow-black/20 border border-slate-200 overflow-hidden">
 ...
 <h2 className="text-xl font-black text-slate-900 mb-2">Delete Registration</h2>
 ...
 {/* Error Banner */}
 {error && (
 <div className="mt-4 flex items-start gap-2 p-3 rounded-lg bg-red-50 border border-red-200 text-left">
 ...
 {/* Actions */}
 <div className="flex items-center gap-3 px-8 py-5 border-t border-slate-200 bg-slate-50">
 <button
 onClick={onClose}
 disabled={deleting}
 className="flex-1 px-5 py-2.5 rounded-lg border border-slate-200 text-sm font-semibold text-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-50"
 >
 Cancel
 </button>
 <button
