...
export default function EditRegistrationModal({
 ...
 const inputClass =
 "h-11 px-4 rounded-lg border border-slate-200 bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-primary focus:border-primary text-sm";
 ...
 <div>
 <h2 className="text-xl font-black text-slate-900 ">Edit Registration</h2>
 ...
 paymentReceived ? "bg-primary" : "bg-slate-300"
 }`}
 >
 <span
