...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Drawer panel */}
      <div
        className={`fixed inset-y-0 right-0 z-[70] w-[85%] max-w-sm bg-white shadow-2xl flex flex-col transition-transform duration-300 ease-out md:hidden ${
      ...
      >
        ...
        <div className="px-6 py-5 border-t border-slate-100">
          <p className="text-[10px] text-center uppercase tracking-widest text-slate-400 font-medium">
            <span className="text-primary">◈</span> IT Training Agency v2.4.0{" "}
