...
const inputClass =
    "h-11 w-full px-4 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-sm transition-all";
...
function Toggle({
    ...
    return (
        <button
            ...
            className={`relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors duration-200 ${enabled ? "bg-primary" : "bg-slate-300"
                }`}
        >
            <span
...
export default function AddAdminPage() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                <h2 className="text-sm font-bold uppercase text-slate-500 tracking-wider mb-5 flex items-center gap-2">
 ...
 className="relative flex size-24 items-center justify-center rounded-full border-2 border-dashed border-slate-300 bg-slate-50 hover:border-primary hover:bg-primary/5 transition-all group overflow-hidden"
 >
 {avatarPreview ? (
 <img
 src={avatarPreview}
 ...
 Upload Photo
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div className="lg:col-span-3 bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-6">
                            ...
                            {MODULE_PERMISSIONS.map((perm) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-3 px-4 py-3 rounded-xl border text-left transition-all duration-200 ${isChecked
                                            ? "border-primary bg-primary/5 ring-1 ring-primary/20"
                                            : "border-slate-200 bg-slate-50/50 hover:border-slate-300"
                                            }`}
                                    >
                                        <div
                                            className={`flex size-8 shrink-0 items-center justify-center rounded-lg transition-colors ${isChecked
                                        ...
                                        <span
                                            className={`text-sm font-medium transition-colors ${isChecked
                                                ? "text-primary"
                                                : "text-slate-600 "
                                                }`}
                                        >
                                        ...
                                        <div className="ml-auto">
                                            <div
                                                className={`flex size-5 items-center justify-center rounded-md border-2 transition-all ${isChecked
                ...
                <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-6 h-fit">
                    {/* <h2 className="text-sm font-bold uppercase text-slate-500 tracking-wider flex items-center gap-2">
 <span className="material-symbols-outlined text-lg text-primary">
 tune
 </span>
                                    ...
                                    {ACCOUNT_STATUSES.map((status) => {
                                        ...
                                        return (
                                            <label
                                                ...
                                                className={`flex items-start gap-3 p-3.5 rounded-xl border cursor-pointer transition-all duration-200 ${isSelected
                                                    ? "border-primary bg-primary/5 ring-1 ring-primary/20"
                                            ...
                                            >
                                                ...
                                                {/* Custom Radio Circle */}
                                                <div
                                                    className={`mt-0.5 flex size-5 shrink-0 items-center justify-center rounded-full border-2 transition-all ${isSelected
                                                        ? "border-primary"
                                                        : "border-slate-300"
                                                        }`}
                                                >
