...
export default function RegistrationsPage() {
 ...
 <td className="px-6 py-4 text-sm text-slate-600 ">{getProgramName(r)}</td>
 <td className="px-6 py-4 text-sm text-slate-500 ">{formatDate(r.createdAt)}</td>
 <td className="px-6 py-4 text-sm font-semibold text-slate-900 ">{getProgramPrice(r)}</td>
 <td className="px-6 py-4">
 <span
