  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white">Add Instructor</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Create a new instructor profile and assign teaching programs.</p>
        </div>
      </div>
