...
export async function POST(request: NextRequest) {
    try {
        ...
        // const instructor = await Instructor.create({ ...body, firstName: firstName.trim(), lastName: lastName.trim(), email: email.trim()?.toLowerCase(), professionalTitle: professionalTitle.trim(), availabilityStatus: availabilityStatus.trim() });
